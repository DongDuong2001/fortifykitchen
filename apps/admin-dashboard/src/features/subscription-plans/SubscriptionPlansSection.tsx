...
export default function SubscriptionPlansSection({
  ...
  const addFeature = (text = '') => {
    setSubPlanFeatures([...subPlanFeatures, text]);
  };
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      <div className="grid lg:grid-cols-3 gap-8">
        <div ref={formRef} className="border border-border bg-card rounded-2xl p-6 shadow-sm h-fit">
          ...
          <form onSubmit={handleSaveSubscriptionPlan} className="space-y-4">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex flex-wrap gap-1 mb-1">
                ...
                {featurePresets.map((preset, pIdx) => (
                  <button
                    key={pIdx}
                    type="button"
                    onClick={() => {
              ...
              <div className="space-y-1.5">
                {subPlanFeatures.map((feature, idx) => (
                  <div key={idx} className="flex items-center gap-1.5">
                    <FontAwesomeIcon icon={faGripVertical} className="h-2.5 w-2.5 text-muted-foreground/40 shrink-0" />
                    <input
                      type="text"
